 ...
 */
class getPokemonTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PokemonTypeRepository' shared autowired service.
     *
     * @return \App\Repository\PokemonTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PokemonTypeRepository.php';

        return $container->privates['App\\Repository\\PokemonTypeRepository'] = new \App\Repository\PokemonTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
