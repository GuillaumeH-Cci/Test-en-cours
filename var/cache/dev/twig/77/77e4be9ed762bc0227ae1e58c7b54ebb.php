...
class __TwigTemplate_40a20655e458a8920754ce46bfa0bc10 extends Template
{
    ...
    ";
        ...
        yield "
            ...
            <div class=\"col\">
                ";
        // line 24
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 24, $this->source); })()), "lastname", [], "any", false, false, false, 24), 'row');
        yield "
            </div>
        </div>
        ...
        yield "        <div class=\"row\">
            <div class=\"col\">
                ";
        // line 33
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 33, $this->source); })()), "plainPassword", [], "any", false, false, false, 33), "first", [], "any", false, false, false, 33), 'row');
        yield "
            </div>
            <div class=\"col\">
                ";
        ...
        ";
        // line 43
        yield "        <button type=\"submit\" class=\"btn btn-danger\">S'inscrire</button>
...
";
    ...
    {
        return array (  181 => 45,  177 => 43,  172 => 40,  165 => 36,  159 => 33,  155 => 31,  150 => 28,  143 => 24,  136 => 20,  129 => 16,  124 => 14,  119 => 12,  114 => 9,  105 => 7,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    {{ form_start(registrationForm) }}
        ...
        {# Il est possible d'appeler le premier input puis le second d'un RepeatedType #}
        <div class=\"row\">
            <div class=\"col\">
        ...
        {# On aurait pu l'intégrer dans le Formulaire TWIG comme pour les autres #}
